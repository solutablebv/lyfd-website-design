            ...
            <div className="prose-lyfd">
                  ...
                  <table className="w-full text-sm border-collapse">
                    <thead>
                      <tr className="border-b-2 border-[#1A1A1A]">
                        <th className="text-left py-3 pr-4 font-semibold text-[#1A1A1A]">Criterium</th>
                        <th className="text-left py-3 pr-4 font-semibold text-[#1A1A1A]">Uitzendbureau</th>
              ...
              <ScrollReveal delay={0.05}>
                <p>
                  ...
                  <a href="/kennisbank/caas-uitgelegd/welk-caas-model/" className="text-[#1A1A1A] underline decoration-[#DCDCDC] underline-offset-4 hover:decoration-[#1A1A1A] transition-colors duration-300">
