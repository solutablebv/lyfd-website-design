...
const faqItems = [
  ...
  { question: "Is CaaS duurder dan een uitzendbureau?", answer: "Op uurtariefniveau kan een uitzendbureau goedkoper lijken. Maar als je de totale kosten meeneemt (inwerktijd door gebrek aan branchekennis, certificeringskosten, geen vervangingsgarantie, kwaliteitskosten door fouten), is CaaS voor specialistisch werk in de liftbranche vrijwel altijd kostenefficienter. Het tarief van LYFD start vanaf EUR 64,99 per uur inclusief alle genoemde componenten. (Bron: LYFD Pricing 2026)" },
