...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Het LYFD-tarief is afhankelijk van het ervaringsniveau van de monteur. Het blended tarief ligt rond EUR 50 per uur (excl. BTW). Daarin zit meer dan alleen een monteur: volledige certificering, gereedschap, vervangingsgarantie bij uitval, DBA-compliance en administratieve afhandeling. (Bron: LYFD Pricing 2026)",
  },
  {
    question:
