        ...
        >
          ...
          >
            ...
            <Link
              href="/"
              className={cn(
                "flex items-center gap-2.5 transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:opacity-80",
              )}
            >
              <img
                src="/logo.svg"
              ...
              />
              <span className={cn(
                "font-bold tracking-tight text-[#1B1D1E] transition-all duration-500",
            ...
            <div className="hidden lg:flex items-center gap-1">
              {navLinks.map((link) => (
                ...
                >
                  <a
                    href={link.href}
                    className="flex items-center gap-1 px-3 py-2 text-sm font-medium rounded-full transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] text-[#888888] hover:text-[#1B1D1E] hover:bg-[#F5F5F5]"
                  >
                    {link.label}
                    {link.hasDropdown && (
                      <CaretDown
                    ...
                    <AnimatePresence>
                      {activeDropdown === link.label && (
                        <motion.div
                          ...
                          className="absolute top-full left-0 mt-2 w-64 rounded-2xl bg-white/90 backdrop-blur-xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.08),0_0_0_1px_rgba(235,235,235,0.5)] border border-[#DDDDDD]/40 p-2"
                        >
                          {link.children?.map((child, i) => (
                            <motion.a
                              ...
                              className="block px-4 py-2.5 text-sm text-[#888888] hover:text-[#1B1D1E] hover:bg-[#F7F7F7] rounded-xl transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]"
                            >
                              {child.label}
                            </motion.a>
                          ))}
      ...
      <AnimatePresence>
        {isMobileOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-[#1B1D1E]/95 backdrop-blur-3xl lg:hidden"
          >
