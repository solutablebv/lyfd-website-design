...
const checkItems = [
  "Je meerdere nieuwbouwprojecten tegelijk hebt lopen en structureel tegen capaciteitsdruk aanloopt",
  "Je incidenteel een groot project binnenkrijgt dat je eigen team overstijgt",
  "Je contractuele opleverdata hebt en het risico van uitval wilt afdekken",
  "Je DBA-compliant wilt opereren zonder zzp-afhankelijkheid",
];

export function NieuwbouwZelfdiagnose() {
  return (
        ...
        <div className="max-w-3xl mx-auto">
          <ScrollReveal>
            <div className="text-center mb-14 md:mb-18">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tighter leading-[1.1] text-[#1A1A1A]">
                Is LYFD nieuwbouwcapaciteit iets voor jou?
              </h2>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.1}>
            <p className="text-base md:text-lg text-[#404040] leading-relaxed text-center mb-10">
              LYFD nieuwbouwcapaciteit is voor jou als:
            </p>
          </ScrollReveal>
