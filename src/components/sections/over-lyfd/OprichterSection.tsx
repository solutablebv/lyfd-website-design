...
function TeamCard({ member }: { member: (typeof teamMembers)[number] }) {
  return (
    <div className="w-60 flex-shrink-0">
      <div className="h-80 rounded-3xl bg-[#F7F7F7] overflow-hidden">
        <div className="w-full h-full flex items-center justify-center bg-[#F7F7F7]">
          <span className="text-4xl font-bold font-mono text-[#888888] tracking-tight select-none">
            {getInitials(member.name)}
          </span>
        </div>
      </div>
      <div className="mt-3 px-1">
        <p className="text-[#1B1D1E] font-semibold tracking-tight text-sm">
          {member.name}
        </p>
      ...
      <Container>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <ScrollReveal delay={0.15}>
            <div className="mt-14 md:mt-18 rounded-3xl bg-[#F7F7F7] border border-[#DDDDDD] p-8 md:p-10">
              <div className="flex flex-col items-center gap-6">
                {/* Avatar met initialen */}
                <div className="w-20 h-20 rounded-full bg-[#1B1D1E] flex items-center justify-center flex-shrink-0">
                ...
                <div className="text-center">
                  ...
                  <p className="mt-1 text-sm font-medium text-[#888888] uppercase tracking-[0.15em]">
                    Oprichter
                  </p>
                  <p className="mt-5 text-sm md:text-base text-[#333333] leading-[1.75] max-w-[52ch] mx-auto">
