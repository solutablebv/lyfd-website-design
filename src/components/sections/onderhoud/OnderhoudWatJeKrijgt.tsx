...
const deliverables = [
  {
    icon: Certificate,
    text: "Gecertificeerde liftmonteurs (NEN 3140, VCA, fabrikantspecifiek) die dag 1 inzetbaar zijn",
  },
  {
    icon: ArrowsClockwise,
    text: "Vervanging bij uitval: wij garanderen continuïteit",
  },
  {
    icon: Van,
  ...
  {
    icon: UserSwitch,
    text: "Chameleon-inzet: monteur werkt onder jouw naam en procedures",
  },
  {
    icon: SlidersHorizontal,
    text: "Keuze uit drie engagementmodellen, van losse uren tot vaste capaciteitsreservering",
  },
  {
    icon: CurrencyEur,
        ...
        <div className="max-w-2xl">
          ...
          <ScrollReveal delay={0.1}>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tighter leading-[1.1] text-[#1A1A1A]">
              Wat levert LYFD voor liftonderhoud?
            </h2>
          </ScrollReveal>
        </div>
