      ...
      <Container>
        ...
        <ScrollReveal delay={0.2}>
          <div className="mt-14 md:mt-20 max-w-4xl mx-auto">
            <div className="rounded-3xl bg-white border border-[#DDDDDD] overflow-hidden shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
              {/* Header row */}
              <div className="grid grid-cols-[1fr_1fr_1fr] border-b border-[#DDDDDD] bg-[#F7F7F7]">
                <div className="p-5 md:p-6">
                  <span className="text-xs uppercase tracking-[0.15em] font-medium text-[#888888]">
                    Aspect
                  </span>
                </div>
                <div className="p-5 md:p-6 border-l border-[#DDDDDD]">
                  <span className="text-xs uppercase tracking-[0.15em] font-medium text-[#888888]">
                    Zonder Chameleon
                  </span>
                </div>
                <div className="p-5 md:p-6 border-l border-[#DDDDDD] bg-[#1B1D1E]">
                ...
                return (
                  ...
                  >
                    <div className="p-5 md:p-6 flex items-start gap-3">
                      ...
                      <span className="text-sm font-medium text-[#1B1D1E]">
                        {aspect.label}
                      </span>
                    </div>
                    <div className="p-5 md:p-6 border-l border-[#DDDDDD] flex items-start">
                      <span className="text-sm text-[#888888] leading-relaxed">
                        {aspect.zonder}
                      </span>
                    </div>
                    <div className="p-5 md:p-6 border-l border-[#DDDDDD] bg-[#1B1D1E] flex items-start">
        ...
        <ScrollReveal delay={0.3}>
          <div className="mt-8 max-w-4xl mx-auto">
            <div className="flex items-center gap-3 justify-center">
              <UserSwitch weight="light" className="w-5 h-5 text-[#888888]" />
